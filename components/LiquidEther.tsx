...
`;
    ...
    class ShaderPass {
      ...
      // FIX: Update method signatures to be compatible with derived classes
      init(..._args: any[]) {
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt, isBounce, BFECC }: { dt: any, isBounce: any, BFECC: any }) {
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous, iterations, dt }: { viscous: any, iterations: any, dt: any }) {
        let fbo_in, fbo_out;
    ...
    class Poisson extends ShaderPass {
      ...
      update({ iterations }: { iterations: any }) {
        let p_in, p_out;
        for (let i = 0; i < iterations; i++) {
          if (i % 2 === 0) {
    ...
    class Simulation {
      ...
      advection: Advection | undefined;
      externalForce: ExternalForce | undefined;
      viscous: Viscous | undefined;
      divergence: Divergence | undefined;
      poisson: Poisson | undefined;
    ...
    class Output {
      ...
      output: THREE.Mesh | undefined;

      constructor() {
        this.init();
      }
      init() {
        // FIX: Pass empty object to Simulation constructor
    ...
    class WebGLManager {
      ...
      autoDriver: AutoDriver | undefined;
      _loop: () => void;
      _resize: () => void;
      _onVisibility: () => void;
      running: boolean;
